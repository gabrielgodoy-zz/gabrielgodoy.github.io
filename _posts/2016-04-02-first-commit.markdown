...
Coming from a design background (you too?), but always interested in front-end, I had one day the opportunity to build a website from the ground-up, when my boss at the time asked me if I could develop a website for the company.
